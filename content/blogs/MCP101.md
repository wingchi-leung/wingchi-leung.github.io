...
- MCP hosts： 发起请求的llm应用程序，如claude desktop，cursor等或者其他ai工具
- MCP client： 内置于hosts里面，负责与server通信，它充当llm和MCP server的沟通桥梁 
- MCP server： 为MCP client提供对特定外部服务的访问
...
Fastmap是一个用于构建MCP的框架，在官方的基础上提供了更加简单的方式来创建MCP服务器，使AI能够访问本地工具和资源。
